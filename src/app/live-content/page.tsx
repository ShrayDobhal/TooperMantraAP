    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="p-8 space-y-6 flex-1 animate-in fade-in duration-300">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-[11px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-md bg-orange-100 text-orange-700 border border-orange-200 inline-flex items-center gap-1.5">
                  ...
                  Target: Student Mobile App → {viewMode === 'INSPIRE' ? 'Inspire Tab (Hub)' : 'My Space → Community'}
                </span>
              </div>
              <h1 className="text-2xl font-bold text-slate-900 tracking-tight flex items-center gap-2">
                {viewMode === 'INSPIRE' ? (
                  <>
                    ...
                    Inspire Hub — Masterclasses & Podcasts
                  </>
                ) : (
                  <>
              ...
              <p className="text-slate-500 text-xs mt-0.5">
                {viewMode === 'INSPIRE'
                  ? 'Podcasts, AIR Topper masterclasses, and inspirational episodes streamed in the student app\'s Inspire Feed.'
          ...
          {/* App Destination Segmented Switcher */}
          ...
          {/* Section-Specific Context Navigation */}
          {viewMode === 'COMMUNITY' ? (
              ...
              {selectedPillar !== 'ALL' && (
                <div className="pt-2.5 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 text-xs text-slate-600">
                  ...
                  <span className="text-[11px] font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200/70 px-2.5 py-0.5 rounded-md inline-flex items-center gap-1.5 self-start sm:self-auto">
                    ...
                    Syncs to Student App → My Space → Community
                  </span>
                </div>
              )}
            </div>
          ) : (
            <div className="bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-transparent p-4 rounded-2xl border border-amber-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-2xs">
              <div className="space-y-0.5">
                <div className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-amber-600" />
                  <span className="text-xs font-bold text-slate-900">Inspire Hub Live Sync</span>
                </div>
                <p className="text-[11px] text-slate-600">
                  All videos uploaded here are marked with <code className="bg-white/80 px-1 py-0.5 rounded font-mono text-[10px] text-amber-800">category: INSPIRE</code> and automatically featured in the student app&apos;s Inspire Tab feed.
                </p>
              </div>
              <span className="text-[11px] font-semibold text-amber-800 bg-amber-100 border border-amber-300/60 px-3 py-1 rounded-lg inline-flex items-center gap-1.5 shrink-0">
                ⭐ Auto-Featured on App Inspire Tab
              </span>
            </div>
          )}
                    ...
                    {videoForm.targetSection === 'INSPIRE' ? (
                      ...
                      <div className="p-4 bg-amber-50/50 border border-amber-200/70 rounded-xl space-y-3">
                        ...
                        <p className="text-[11px] text-amber-800 flex items-center gap-1.5">
                          <span>✨</span>
                          <span>Automatically featured at the top of the mobile app&apos;s Inspire Tab feed.</span>
                        </p>
                      </div>
                    ) : (
                    ...
                    {videoForm.targetSection === 'INSPIRE' ? (
                      <div className="p-4 bg-amber-50/60 border border-amber-200/70 rounded-xl space-y-1.5">
                        ...
                        <p className="text-[11px] text-amber-800">
                          Inspire Hub masterclasses and podcasts are globally accessible to all registered students across all partner schools via the Inspire Tab feed.
                        </p>
                      </div>
                    ) : (
